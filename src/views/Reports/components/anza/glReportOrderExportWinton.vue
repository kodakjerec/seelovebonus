<template>
  <div>
    <el-form ref="form" :model="form" label-width="10vw" label-position="right">
      <el-form-item :label="$t('__collectionRecords')+'：'+$t('__startDate')">
        <el-col :span="8">
          <el-date-picker
      ...
      <el-form-item :label="$t('__orderPaper')+'：'+$t('__number')">
        <el-col :span="8">
      ...
      <el-form-item :label="$t('__keyword')">
        ...
        <el-col :span="8">
          <el-checkbox v-model="form.checked1" :label="$t('__salesReportInfo')"></el-checkbox>
        </el-col>
      </el-form-item>
      <el-form-item>
        <el-button v-show="buttonsShowUser.edit" type="primary" icon="el-icon-printer" @click.prevent="print">{{$t('__export')+$t('__salesReport')}}</el-button>
      </el-form-item>
    </el-form>
