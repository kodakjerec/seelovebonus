...
const routes = [
  ...
  },
  {
    ...
    name: 'AnzaOrderRenew',
    component: () => import('@/views/Orders/components/anza/reNew/anzaOrderRenew'),
    props: true
  },
  {
    path: '/Orders/AnzaOrderChangeStorage',
    name: 'AnzaOrderChangeStorage',
    component: () => import('@/views/Orders/components/anza/anzaChangeStorage'),
    props: true
  },
  // Reports
  {
  ...
  {
    path: '/Reports/GlReportOrderExportMGear',
    name: 'GlReportOrderExportMGear',
    component: () => import('@/views/Reports/components/anza/glReportOrderExportMGear')
  },
  {
